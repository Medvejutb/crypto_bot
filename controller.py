...
#         binance_task = asyncio.create_task(self.binance.start_socket(queue))

#         logger.debug('[SYSTEM] Запускаем WebSocket Bitget...')
#         bitget_task = asyncio.create_task(self.bitget.start_socket(queue))

#         logger.debug('[SYSTEM] Запускаем WebSocket OKX...')
#         okx_task = asyncio.create_task(self.okx.start_socket(queue))

#         logger.debug('[SYSTEM] Запускаем WebSocket BYBIT...')
#         bybit_task = asyncio.create_task(self.bybit.start_socket(queue))

#         logger.debug('[SYSTEM] Запускаем WebSocket GATE...')
#         gate_task = asyncio.create_task(self.gate.start_socket(queue))
